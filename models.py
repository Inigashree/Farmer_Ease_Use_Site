...
class Customer(db.Model):
    ...
    password = db.Column(db.String(100), nullable=False)
    registered_for_transport = db.Column(db.Boolean, default=False)

    def __init__(self, name, email, phone_no, address, password, registered_for_transport=False):
        self.name = name
        self.email = email
        self.phone_no = phone_no
        self.address = address
        self.password = password
        self.registered_for_transport = registered_for_transport
